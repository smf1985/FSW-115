...
let margaritas = document.createElement("h2");
margaritas.textContent = `Here is a list of different kinds of Margaritas.`;
document.body.appendChild(margaritas);
let ulist = document.createElement("ul");
for (drinks of margarita.drinks) {
    ulist.innerHTML += `<li>Names: ${drinks.strDrink}, Category: ${drinks.strCategory}</li>`;
    }
